export const Texts = {
    spanish: {
        home: {
            ...
            about: {
                ...
                titlePlace: 'Destino Bariloche',
                hotel: 'La inolvidable experiencia de disfrutar Bariloche más que nunca. A metros del Lago Nahuel Huapi, se encuentra nuestro hotel, con 75 habitaciones listas para recibirte. Está pensado para aquellos visitantes que quieren venir a disfrutar de nuestro destino, pero a la vez poder relajarse en un lugar tranquilo, y así, poder seguir planeando la travesía. Nuestros clientes son nuestros amigos e invitados, por lo tanto , estamos preparados para hacerte sentir en casa!',
                place: 'Bariloche, Capital Nacional del Turismo Aventura y del Chocolate, es uno de los destinos más buscados dentro de Argentina. ¿Por que? Está rodeada de bosques milenarios, montañas imponentes blanquesinas y lagos sacados de cuentos. Podes disfrutar un clima cálido en primavera- verano,  con días mas largos para aprovecharlos al máximo haciendo senderismo al aire libre, visitando las playas lacustres, o realizar excursiones a las reservas naturales. En invierno podrás disfrutar de la nieve, de paisajes soñados y si te gustan los deportes como el sky o snowboard, esta es tu estación para visitarnos.',
            },
        ...
        games: {
            ...
            cardShortDescription4: 'Ayuda a Juan',
    ...
    english: {
        home: {
            ...
            about: {
                titleHotel: 'Welcome',
                titleHotel2: 'to Grand Hotel Bariloche',
                titlePlace: 'Destination Bariloche',
                hotel: 'The unforgettable experience of enjoying Bariloche more than ever. A few meters from the Nahuel Huapi Lake, is our hotel, with 75 rooms ready to receive you. It is designed for those visitors who want to come and enjoy our destination, but at the same time be able to relax in a quiet place, and thus, be able to continue planning the journey. Our clients are our friends and guests, therefore, we are prepared to make you feel at home!',
                place: 'Bariloche, National Capital of Adventure Tourism and Chocolate , is one of the most sought after destinations in Argentina. Why? It is surrounded by ancient forests, imposing whitish mountains and fairytale lakes. You can enjoy a warm climate in spring-summer, with longer days to make the most of them by hiking outdoors, visiting the lake beaches, or taking excursions to nature reserves. In winter you can enjoy the snow, dream landscapes and if you like sports like sky or snowboarding, this is your season to visit us.',
            },
            video: 'title video',
            guests: {
        ...
        games: {
            ...
            cardShortDescription1: 'Is that discount and snow? Yes! Catch all the snowflakes you can and manage to build a giant snow bar. The more flakes you catch, bigger discounts you get ',
            cardShortDescription2: 'A game to lock, have fun and win! You must knock on the door of the rooms in order to wake up the passengers and not miss the plane! The faster you do it .. bigger discount you win! ',
